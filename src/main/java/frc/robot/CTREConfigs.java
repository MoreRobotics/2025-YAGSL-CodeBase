...
public final class CTREConfigs {
    ...
    public CTREConfigs(){
        ...
        /*TODO
        Phoenix 6 replacements
        
        SupplyCurrentThreshold is now SupplyCurrentLowerLimit
        SupplyTimeThreshold is now SupplyCurrentLowerTime

        Look into these values and tune them. Pheonix 6 documentation defaults to the following

        SupplyCurrentLowerLimit = 40
        SupplyCurrentLowerTime = 0.1
